        ...
        <div class="row">
            <div class="col">
                <div class="section_title_container text-center">
                    <h2 class="section_title">Welcome To Galery Foto</h2>
                </div>
            </div>
        </div>
        <div class="row about_row">
            ...
            <?php foreach ($galery as $key => $value) { ?>
                <div class="col-lg-4 about_col about_col_left">
                    <div style="color: black" class="about_item">
                        <div class="about_item_image"><img src="<?= base_url('sampul/' . $value->sampul) ?>" width="300px" height="160px"></div>
                        <div class="about_item_title"><a href="<?= base_url('home/detail_galery/' . $value->id_galeri) ?>"><?= $value->nama_galeri ?></a></div>
