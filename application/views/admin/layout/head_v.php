...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?= base_url() ?>template/backend/css/dataTables/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?= base_url() ?>template/backend/css/dataTables/dataTables.responsive.css" rel="stylesheet">
