    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label>NPM</label>
                <input class="form-control" type="text" name="npm" placeholder="Masukan Angka / NPM" required>
            </div>

            <div class="form-group">
                <label>Nama Mahasiswa</label>
                <input class="form-control" type="text" name="nama_mahasiswa" placeholder="Masukan Nama Mahasiswa" required>
            </div>
